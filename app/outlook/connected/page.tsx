...
const REASONS: Record<string, string> = {
  ...
  norefresh: 'Microsoft didn\'t grant ongoing access. Please try again and accept all the permissions.',
  nouser: 'We couldn\'t match this to a SchoolBrief account. Sign up first, then connect Outlook.',
...
function Connected() {
  ...
  if (status !== 'ok') {
    return (
      <div className="bg-white p-8 rounded-xl shadow max-w-md w-full text-center">
        ...
        <h1 className="text-2xl font-bold mb-2 text-gray-900">Couldn't connect Outlook</h1>
  ...
  return (
    <div className="bg-white p-8 rounded-xl shadow max-w-md w-full">
      ...
      <h1 className="text-2xl font-bold mb-2 text-gray-900 text-center">Outlook connected!</h1>
